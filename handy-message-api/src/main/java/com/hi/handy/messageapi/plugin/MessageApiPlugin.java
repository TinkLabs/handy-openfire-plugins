...
public class MessageApiPlugin implements Plugin {

  private static final Logger LOGGER = LoggerFactory.getLogger(MessageApiPlugin.class);
  ...
  public void initializePlugin(PluginManager manager, File pluginDirectory) {
    LOGGER.info("MessageApiPlugin init============");
  ...
  public void destroyPlugin() {
    LOGGER.info("MessageApiPlugin destory============");
