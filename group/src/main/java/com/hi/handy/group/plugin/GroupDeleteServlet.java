...
import com.hi.handy.group.plugin.parameter.GroupDeleteParameter;
...
public class GroupDeleteServlet extends HttpServlet {
  private static final Logger LOGGER = LoggerFactory.getLogger(GroupDeleteServlet.class);
  private static final String SERVICE_URL = "group/delete";
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    try {
      GroupDeleteParameter parameter = mapper.readValue(req.getInputStream(), GroupDeleteParameter.class);
      Object result = GroupService.getInstance().deleteGroup(parameter);
