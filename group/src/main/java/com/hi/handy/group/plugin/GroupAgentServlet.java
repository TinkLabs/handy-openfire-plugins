...
import com.hi.handy.group.plugin.parameter.GroupAgentParameter;
...
public class GroupAgentServlet extends HttpServlet {
  private static final Logger LOGGER = LoggerFactory.getLogger(GroupAgentServlet.class);
  private static final String SERVICE_URL = "group/addagent";
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    try {
      GroupAgentParameter parameter = mapper.readValue(req.getInputStream(), GroupAgentParameter.class);
      GroupService.getInstance().addGroupAgent(parameter);
