...
public class GroupRelationServlet extends HttpServlet {
  private static final Logger LOGGER = LoggerFactory.getLogger(GroupRelationServlet.class);
  private static final String SERVICE_URL = "group/addrelation";
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    try {
      GroupRelationParameter parameter = mapper.readValue(req.getInputStream(), GroupRelationParameter.class);
      Object result = GroupService.getInstance().addGroupRelation(parameter);
